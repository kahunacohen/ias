...
# Author: 2004-2008 GulÃÂ¡csi TamÃÂ¡s
#
# Ported from Josh Carter's Perl IPTCInfo.pm by TamÃÂ¡s GulÃÂ¡csi
#
# IPTCInfo: extractor for IPTC metadata embedded in images
# Copyright (C) 2000-2004 Josh Carter <josh@multipart-mixed.com>
# Copyright (C) 2004-2008 TamÃÂ¡s GulÃÂ¡csi <gthomas@gthomas.hu>
# All rights reserved.
#
...
Ported from Josh Carter's Perl IPTCInfo-1.9.pm by TamÃÂ¡s GulÃÂ¡csi
...
Thanks,
TamÃÂ¡s GulÃÂ¡csi <gthomas at fw dot hu>
...
__version__ = '1.9.5-6'
__author__ = u'GulÃÂ¡csi, TamÃÂ¡s'
